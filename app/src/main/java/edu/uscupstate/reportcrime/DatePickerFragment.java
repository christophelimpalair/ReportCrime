...
public class DatePickerFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog ( Bundle savedInstanceState ) {
        // get the date from the argument and use it to initialize DatePicker
    ...
    // creating and setting fragment arguments is typically done in a newInstance() method
    // that replaces the fragment constructor
